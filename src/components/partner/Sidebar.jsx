  ...
  return (
    <div className={`partner-sidebar bg-darkBlue text-lightGray ${isActive ? 'active' : ''}`}>
        ...
        <div>
            ...
            <ul style={{marginLeft : '-30px'}}>
                <li>
                    <NavLink activeClassName='active' target="_blank" className='text-lightGray fs-small' to='/partnersLocation' style={{textDecoration: 'none'}}>
                        <BsPeople />
                        <span>Community</span>
                    </NavLink>
                    <NavLink activeClassName='active' className='text-lightGray fs-small' to='/partner/dashboard/customer-support' style={{textDecoration: 'none'}}>
                    ...
                    <NavLink activeClassName='active' className='text-lightGray fs-small' to='/partner/dashboard/profile' style={{textDecoration: 'none'}}>
                        <IoSettingsOutline />
                        <span>Settings</span>
                    </NavLink>
                </li>
