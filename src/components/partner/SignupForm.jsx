            ...
            <div className="col-lg-5 col-md-6 m-auto">
                <div className="auth-links-container">
                    <div className="auth-links">
                        <Link to="/partner/login" className='auth-link text-light'>Login</Link>
                        <Link to="/partner/signup" className='auth-link text-light active'>Sign up</Link>
                    </div>
                </div>
                ...
                <h6 className='text-center mb-0 mt-4'>
                    <Link to='/customer/signup' className='text-light fs-small fw-light'>Sign up as Customer</Link>
                </h6>
            </div>
        </div>
    </div>
