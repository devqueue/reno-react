        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content p-3">
            <div class="modal-body">
              ...
              />
              <button
                className="btn bg-darkBlue w-100 rounded-3 text-light mb-2"
              ...
              <button
                className="btn bg-light border modal-cancel border-color-darkBlue w-100 rounded-3 text-darkBlue"
