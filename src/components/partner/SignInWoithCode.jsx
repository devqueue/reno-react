...
import { signInMerchantWithCode } from "../../api/MerchentApi";
...
const LoginForm = () => {
  ...
  const sendData = async () => {
    setIsFetching(true);
    const { data } = await signInMerchantWithCode(userData);
            ...
            <div className="pass-container">
              <div className="auth-input-container">
                <input
                  ...
                  placeholder="Please enter your 4 digits Code..."
                  value={userData?.code}
                  onChange={(e) =>
                    setUserDate({ ...userData, code: e.target.value })
                  }
                  required
                  pattern="\d*"
                  maxlength="4"
