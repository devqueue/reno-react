                    ...
                    <div className="form-group mb-2" >
                        ...
                        <div className='pass-container'>
                            <div className="auth-input-container">
                                <input type="number" className='form-control px-3' placeholder='Please enter your 4 digits Code...' value={userData?.code} onChange={(e) => setUserDate({...userData , code : e.target.value})} required pattern="\d*" maxlength="4"   />
                            </div>
                        </div>
                    </div>
                    {
