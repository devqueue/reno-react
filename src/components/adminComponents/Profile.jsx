...
import {getAllNotificationsOfCustomer ,markNotificationsOfMerchantRead , checkUserPassword , updateUserPassword ,getAdminDetails ,updateAdminPic ,updateAdminDetails } from '../../api/AdminApi'
    ...
    const updateMyData = async () => {
        ...
        if(isChanged == false){
            ...
            if(data?.success === true){
                ...
                localStorage.setItem("reno-adminName", JSON.stringify(userDetails?.userName));
            }else{
                toast.error(data?.message)
            }
        }
                        ...
                        <div className="col-lg-12">
                            <div className="d-flex justify-content-between mb-4" >
                                <div className="form-group mb-4 col-lg-4">
                                    <img style={{maxWidth: '100px', maxHeight : '100px', borderRadius : '50%' }} alt="user image" src={  userDetails?.profilePic.indexOf("https") == 0 ? userDetails?.profilePic : process.env.REACT_APP_API_SERVER_URL + "/adminProfileImages/" + userDetails?.profilePic} />
                                </div>
                                <div className="form-group mb-4 col-lg-4">
                                    {
                                        uploadImage !== "" && (
                            ...
                            <div className='d-flex' >
                                <div className="form-group mb-4 col-lg-5"  >
                                    ...
                                    <div className='pass-container'  >
                                        <input type="email" className='form-control px-3' disabled={true} value={userDetails?.email} />
                                    </div>
                                </div>
                                <div className="form-group mb-4 col-lg-6" style={{marginLeft: '15px' }}>
                                    <label className='form-label' >Your Name</label>
                                    <div className='pass-container'  >
                                        <input type="text" className='form-control px-3' onChange={(e) => setUserDetails({...userDetails, userName : e.target.value})} value={userDetails?.userName} />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='d-flex' >
                                <div className="form-group mb-4 col-lg-5"   >
                                    ...
                                    <div className='pass-container'  >
                                        <input type="text" className='form-control px-3' onChange={(e) => setUserDetails({...userDetails, address : e.target.value})} value={userDetails?.address} />
                                    </div>
                                </div>
                                <div className="form-group mb-4 col-lg-6" style={{marginLeft: '15px' }}>
