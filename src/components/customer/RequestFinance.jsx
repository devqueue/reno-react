...
const RequestFinance = () => {
  ...
  const checkStep01 = () => {
    ...
    if (
      quoteDate?.homeType === "" ||
      quoteDate?.martialStatus === "" ||
      quoteDate?.homeSize === 0 ||
      quoteDate?.familyMembersCount === 0 ||
      quoteDate?.familyMembersFees === 0 ||
      quoteDate?.workingStatus === 0
    ) {
  ...
  const checkStep03 = () => {
    if (
      quoteDate?.housingExpense === 0 ||
      quoteDate?.homeWorkerWageExpense === 0 ||
      quoteDate?.healthCareExpense === 0 ||
      quoteDate?.foodBeverageExpense === 0 ||
      quoteDate?.transportationExpense === 0
    ) {
      toast.error("Please Provide All Fields");
    } else {
      setStep(4);
            ...
            <div className="row finance-form mt-4">
              <div className="col-lg-6 form-group mb-4">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setQuoteData({ ...quoteDate, isOwned: e.target.value })
                  }
                >
              ...
              <div className="col-lg-6 form-group mb-4">
                ...
                <select
                  ...
                  aria-label="Default select example"
                  onChange={(e) =>
                    setQuoteData({ ...quoteDate, homeType: e.target.value })
                  }
                >
                  <option selected disabled></option>
              ...
              <div className="col-lg-6 form-group mb-4">
                ...
                <input
                  ...
                  value={quoteDate?.homeLocation}
                  onChange={(e) =>
                    setQuoteData({ ...quoteDate, homeLocation: e.target.value })
                  }
                  required
                />
              </div>
              <div className="col-lg-6 form-group mb-4">
                ...
                <input
                  ...
                  value={quoteDate?.homeSize}
                  onChange={(e) =>
                    setQuoteData({ ...quoteDate, homeSize: e.target.value })
                  }
                  required
                />
              </div>
              ...
              <div className="col-lg-6 form-group mb-4">
                ...
                <input
                  ...
                  value={quoteDate?.familyMembersFees}
                  onChange={(e) =>
                    setQuoteData({
                      ...quoteDate,
              ...
              <div className="col-12 mt-4 d-flex justify-content-center step-btns-container">
                <Link
                  to="/customer/dashboard/quotesReceived"
            ...
            <div className="row finance-form mt-4">
              <div className="col-12 form-group mb-4">
                ...
                <input
                  ...
                  value={quoteDate?.basicSalary}
                  onChange={(e) =>
                    setQuoteData({ ...quoteDate, basicSalary: e.target.value })
                  }
                  required
                />
              </div>
              <div className="col-12 form-group mb-4">
                ...
                <input
                  ...
                  value={quoteDate?.housingAllowance}
                  onChange={(e) =>
                    setQuoteData({
                      ...quoteDate,
              ...
              <div className="col-12 form-group mb-4">
                ...
                <input
                  ...
                  value={quoteDate?.otherAllowance}
                  onChange={(e) =>
                    setQuoteData({
                      ...quoteDate,
              ...
              <div className="col-lg-6 mt-4">
                <div className="expense-card">
                  ...
                  <input
                    ...
                    class="form-range"
                    id="customRange1"
                    value={quoteDate?.housingExpense}
                    onChange={(e) =>
                      setQuoteData({
                        ...quoteDate,
              ...
              <div className="col-lg-6 mt-4">
                <div className="expense-card">
                  ...
                  <input
                    ...
                    class="form-range"
                    id="customRange1"
                    value={quoteDate?.homeWorkerWageExpense}
                    onChange={(e) =>
                      setQuoteData({
                        ...quoteDate,
                  ...
                  <div className="d-flex fw-600 justify-content-between">
                    <div className="text-darkBlue fs-small">
                      {quoteDate?.homeWorkerWageExpense}.00{" "}
                      <span className="text-muted fw-normal"> SAR/month</span>
                    </div>
                    {/* <div className='text-darkBlue fs-small'>
                                                0.00<span className='text-muted fw-normal'> SAR/month</span>
              ...
              <div className="col-lg-6 mt-4">
                <div className="expense-card">
                  ...
                  <input
                    ...
                    class="form-range"
                    id="customRange1"
                    value={quoteDate?.foodBeverageExpense}
                    onChange={(e) =>
                      setQuoteData({
                        ...quoteDate,
                  ...
                  <div className="d-flex fw-600 justify-content-between">
                    <div className="text-darkBlue fs-small">
                      {quoteDate.foodBeverageExpense}.00{" "}
                      <span className="text-muted fw-normal"> SAR/month</span>
                    </div>
                    {/* <div className='text-darkBlue fs-small'>
                                                0.00 <span className='text-muted fw-normal'> SAR/month</span>
              ...
              <div className="col-lg-6 mt-4">
                <div className="expense-card">
                  ...
                  <input
                    ...
                    class="form-range"
                    id="customRange1"
                    value={quoteDate?.healthCareExpense}
                    onChange={(e) =>
                      setQuoteData({
                        ...quoteDate,
                  ...
                  <div className="d-flex fw-600 justify-content-between">
                    <div className="text-darkBlue fs-small">
                      {quoteDate?.healthCareExpense}.00{" "}
                      <span className="text-muted fw-normal"> SAR/month</span>
                    </div>
                    {/* <div className='text-darkBlue fs-small'>
              ...
              <div className="col-lg-6 mt-4">
                <div className="expense-card">
                  ...
                  <input
                    ...
                    class="form-range"
                    id="customRange1"
                    value={quoteDate?.transportationExpense}
                    onChange={(e) =>
                      setQuoteData({
                        ...quoteDate,
                  ...
                  <div className="d-flex fw-600 justify-content-between">
                    <div className="text-darkBlue fs-small">
                      {quoteDate?.transportationExpense}.00{" "}
                      <span className="text-muted fw-normal"> SAR/month</span>
                    </div>
                    {/* <div className='text-darkBlue fs-small'>
                                                0.00 <span className='text-muted fw-normal'> SAR/month</span>
                  ...
                  <ul className="fs-small mb-0 p-3">
                    <li className="d-flex py-2 border-bottom align-items-center justify-content-between">
                      ...
                      <span className="fw-600 text-end">
                        {quoteDate?.isOwned === true ? "Owned" : "Rented"}
                      </span>
                    </li>
                    <li className="d-flex py-2 border-bottom align-items-center justify-content-between">
                ...
                <div className="review-card">
                  ...
                  <ul className="fs-small mb-0 p-3">
                    ...
                    <li className="d-flex py-2 border-bottom align-items-center justify-content-between">
                      ...
                      <span className="fw-600 text-end">
                        {quoteDate?.homeWorkerWageExpense}
                        <span className="text-muted fw-normal"> SAR</span>
                      </span>
                    </li>
                    <li className="d-flex py-2 border-bottom align-items-center justify-content-between">
                    ...
                    <li className="d-flex py-2 border-bottom align-items-center justify-content-between">
                      ...
                      <span className="fw-600 text-end">
                        {quoteDate?.transportationExpense}{" "}
                        <span className="text-muted fw-normal"> SAR</span>
                      </span>
                    </li>
                    <li className="d-flex py-2 border-bottom align-items-center justify-content-between">
